                ...
                <div className="items-center lg:flex">
                    <div className="lg:w-1/2">
                        ...
                        <p className="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md">
                            Hi I am jane , software engineer <span className="font-bold text-blue-600 dark:text-blue-400">BakaTeam</span> , Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum in sed non alias, fugiat, commodi nemo ut fugit corrupti dolorem sequi ex veniam consequuntur id, maiores beatae ipsa omnis aliquam?
                        </p>

                        <div className="flex items-center mt-12 -mx-2">

                            <a className="mx-2" href="#" aria-label="Facebook">
                                <svg className="w-8 h-8 text-gray-700 fill-current dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
